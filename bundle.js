...
function (_Usuario) {
  ...
  function Admin(email, senha) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Admin).call(this, email, senha));
    _this2.admin = true;
    return _this2;
  }
...
console.log("user is admin: ".concat(user.isAdmin()));
console.log("admin is admin: ".concat(admin.isAdmin()));
